			...
			<View style = {noneModeStyles._activity_2}    >
				...
				<View style = {noneModeStyles._Group_9}    >
					<View style = {noneModeStyles._vscode_icons_file_type_pdf}    >
						...
						<View style = {noneModeStyles._layer_4a6dd9}    >
							<View style = {noneModeStyles._layer_7c2169}   >
						...
						<View style = {noneModeStyles._layer_a8bda1}    >
							<View style = {noneModeStyles._layer_664ef1}   >
						...
						<View style = {noneModeStyles._layer_9db12e}    >
							<View style = {noneModeStyles._layer_a2c673}   >
						...
						<View style = {noneModeStyles._layer_977ecd}    >
							<View style = {noneModeStyles._layer_593551}   >
								<Svg style={{height: 10, width: 10}} viewBox = "0 0 10 10">
						...
						<View style = {noneModeStyles._layer_ace9e8}    >
							<View style = {noneModeStyles._layer_9284fc}   >
						...
						<View style = {noneModeStyles._layer_e51395}    >
							<View style = {noneModeStyles._layer_54f37a}   >
								<Svg style={{height: 8, width: 22}} viewBox = "0 0 22 8">
				...
				<View style = {noneModeStyles._Group_11}    >
					<View style = {noneModeStyles._vscode_icons_file_type_photoshop2}    >
						...
						<View style = {noneModeStyles._layer_9d80c8}    >
							<View style = {noneModeStyles._layer_1c2464}   >
								<Svg style={{height: 35, width: 27}} viewBox = "0 0 27 35">
									<Path fill = {"#070444"}     d = "M19.0775 0H0V35H26.1375V7.36L19.1637 0.09L19.0775 0Z"/>
								</Svg>
							</View>
						</View>
						<View style = {noneModeStyles._layer_de7f7e}    >
							<View style = {noneModeStyles._layer_1b493e}   >
								<Svg style={{height: 10, width: 26}} viewBox = "0 0 26 10">
									<Path fill = {"#5BC3F6"}     d = "M0 0H25.8886V9.99999H0V0Z"/>
								</Svg>
							</View>
						</View>
						<View style = {noneModeStyles._layer_fbaefe}    >
							<View style = {noneModeStyles._layer_d6b4da}   >
						...
						<View style = {noneModeStyles._layer_a0c0ca}    >
							<View style = {noneModeStyles._layer_c22276}   >
						...
						<View style = {noneModeStyles._layer_a548d8}    >
							<View style = {noneModeStyles._layer_ad9824}   >
			...
			<View style = {noneModeStyles._bottom_bar}    >
				...
				<View style = {noneModeStyles._Group_11_2}    >
					...
					<View style = {noneModeStyles._Group_4}    >
						<View style = {noneModeStyles._Group_5}    >
							<View style = {noneModeStyles._Group_10}    >
								...
								<View style = {noneModeStyles._layer_09cf90}    >
									<View style = {noneModeStyles._layer_95cfec}   >
					...
					<View style = {noneModeStyles._Group_9_2}    >
						...
						<Text style = {noneModeStyles._Activity_2}   >
							ИРЦ
						</Text>
					</View>
